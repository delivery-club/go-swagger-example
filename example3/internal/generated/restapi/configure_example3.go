...
//go:generate swagger generate server --target ../../generated --name Example3 --spec ../../../swagger-api/swagger.yml --template-dir ./swagger-templates/templates

func configureFlags(api *operations.Example3API) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.Example3API) http.Handler {
